...
CREATE TABLE `cart` (
                        ...
                        CONSTRAINT `cart_ibfk_2` FOREIGN KEY (`merchant_id`) REFERENCES `merchant` (`id`) ON DELETE CASCADE,
                        CONSTRAINT `cart_ibfk_3` FOREIGN KEY (`product_id`) REFERENCES `product` (`id`) ON DELETE CASCADE
...
ALTER TABLE user ADD COLUMN address VARCHAR(255) DEFAULT NULL AFTER avatar;
...
CREATE TABLE `review` (
                          ...
                          `type` tinyint NOT NULL COMMENT '1-商家 2-商品 3-骑手',
...
-- product 表新增
ALTER TABLE product ADD COLUMN rating decimal(2,1) DEFAULT '5.0' AFTER sales;
ALTER TABLE product ADD COLUMN review_count int DEFAULT 0 AFTER rating;

-- merchant 表新增（rating 已有）
ALTER TABLE merchant ADD COLUMN review_count int DEFAULT 0 AFTER rating;

-- rider 表新增（rating 已有）
ALTER TABLE rider ADD COLUMN review_count int DEFAULT 0 AFTER rating;
